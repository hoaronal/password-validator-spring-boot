...
public class ValidationController extends BaseController {
    ...
    public ResponseEntity<ValidatePasswordResponse> validatePassword(@Validated @RequestBody LoginInput loginInputData, BindingResult bindingResult, Locale locale) {
